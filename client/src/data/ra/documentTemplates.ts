...
/**
 * CE 技术文件模板 — 参考真实 CE 技术文件结构（8 大类）
 * 基于 MDR (EU) 2017/745 Annex II & III 要求
 */
export const documentTemplates: DocumentModule[] = [
  // ==================== 第1类：器械描述与规范 ====================
  {
    id: "section_01",
    title: "第1部分：器械描述与规范",
    ...
    documents: [
      ...
      },
      {
        ...
        sections: [
          ...
          s("cer_device_desc", "器械描述", "Device Description"),
...
export function getAllDocuments(): DocumentDefinition[] {
  return documentTemplates.flatMap((m) => m.documents);
}
